		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title">
					<?php
						if ( is_category() ) :
							printf( __( 'Category Archives: %s', 'paolettibibite' ), '<span>' . single_cat_title( '', false ) . '</span>' );

						elseif ( is_tag() ) :
							printf( __( 'Tag Archives: %s', 'paolettibibite' ), '<span>' . single_tag_title( '', false ) . '</span>' );
