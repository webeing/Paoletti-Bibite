...
function paolettibibite_custom_scripts() {
    ...
    wp_enqueue_script( 'paolettibibite-scrollTo', get_template_directory_uri() . '/js/jquery.scrollTo-1.4.2-min.js', array('jquery'), null, true );
 ...
 */
/*
function paolettibibite_scripts() {
	wp_enqueue_style( 'paolettibibite-style', get_stylesheet_uri() );

	wp_enqueue_script( 'paolettibibite-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'paolettibibite-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'paolettibibite-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );
	}
}
add_action( 'wp_enqueue_scripts', 'paolettibibite_scripts' );
*/
/**
